...
VALUES ('매일 새로운 헤어스타일로 깨어나기 VS 매일 새로운 옷차림으로 깨어나기'),
       ...
       ('영원히 젊게 살기 VS 무한한 지혜 가지기'),
       ('과거 큰 실수 하나를 바로잡을 수 있는 기회 VS 미래의 큰 성공을 보장받는 기회'),
       ('책 속 모든 지혜를 내 것으로 만들기 VS 영화 속 모든 기술을 내 것으로 만들기'),
       ('항상 사람들을 웃게 만드는 유머 감각 가지기 VS 새로운 아이디어로 감탄을 자아내는 창의력 가지기'),
...
values
    ('따뜻한 아침 인사를 보내세요'),
    ('좋아하는 음악 플레이리스트를 만들어 공유하세요'),
    ('응원의 글귀를 작성해 메시지로 보내세요'),
    ('최근 성취를 칭찬하는 메모를 남겨주세요'),
    ('건강을 위해 집에서 할 수 있는 간단한 운동 루틴을 제안하세요'),
    ('오늘 하루를 긍정적으로 시작할 수 있는 명언을 보내주세요'),
    ('직접 그린 그림을 선물하세요'),
    ('직접 작성한 손편지를 보내세요'),
    ('편안한 밤을 위한 ASMR 비디오나 음악을 추천해주세요'),
    ('취미나 관심사에 관련된 책을 추천해주세요'),
    ('새로운 취미 활동을 제안하세요'),
    ('작은 선물을 전달하세요'),
    ('이번 주 목표를 함께 세우고 응원하세요'),
    ('건강한 간식 레시피를 공유하세요'),
    ('자기 관리 팁을 공유하세요'),
    ('주변 자연을 즐길 수 있는 산책이나 하이킹 장소를 추천해주세요'),
    ('개인화된 모닝 루틴을 제안하세요'),
    ('영감을 주는 이야기나 책을 추천하세요'),
    ('향기로운 캔들이나 아로마테라피 제품을 선물하세요'),
    ('응원하고 지지하는 메시지를 보내세요'),
    ('좋아하는 캐릭터를 그려서 선물하세요'),
    ('본인이 좋아하는 음료를 가져다 주세요'),
    ('간단하게 먹을 수 있는 작은 간식을 선물하세요'),
    ('가방이나 책상에 몰래 응원문구를 담은 포스트잇을 붙여주세요'),
    ('노래를 추천해주세요'),
    ('재미있는 퀴즈를 보내주세요'),
    ('아재개그를 보내주세요'),
    ('웃긴 릴스나 쇼츠를 보내세요');
